...
class Client
{
    ...
    private $responseParserMapping = [
        ...
        'Todstoychev\Econt\Request\CountriesRequest' => 'Todstoychev\Econt\Parser\CountriesResponseParser',
    ...
    private $requestBuilderMapping = [
        ...
        'Todstoychev\Econt\Request\CountriesRequest' => 'Todstoychev\Econt\RequestBuilder\ServiceRequestBuilder',
